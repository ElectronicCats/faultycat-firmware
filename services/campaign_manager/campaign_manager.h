...
typedef bool (*campaign_step_executor_t)(uint32_t step, const campaign_config_t* cfg,
                                         uint32_t delay, uint32_t width, uint32_t power,
                                         uint8_t* out_fire_status, uint8_t* out_verify_status,
                                         uint32_t* out_target_state, void* user);
